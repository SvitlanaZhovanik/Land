...
export const Section = styled.section`
  ...
  @media screen and (min-width: 768px) {
    ...
    padding-top: ${props => (props.pb ? '420px' : 0)};
  }
  @media screen and (min-width: 1360px) {
    padding-bottom: ${props => (props.pb ? '330px' : 0)};
    padding-top: ${props => (props.pb ? ' 320px' : 0)};
  }
  @media screen and (min-width: 1920px) {
    padding-bottom: ${props => (props.pb ? '410px' : 0)};
    padding-top: ${props => (props.pb ? ' 370px' : 0)};
  }
`;
...
export default function HeroSection() {
  return (
    <Section id="home" pb="96px" pt="160px">
